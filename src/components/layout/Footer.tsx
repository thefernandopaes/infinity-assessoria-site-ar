    ...
    <footer className="gradient-dark text-white">
      <div className="container mx-auto px-4 lg:px-8 pt-16 pb-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8">
          ...
          <div className="lg:col-span-3">
            ...
            <ul className="space-y-2.5 text-sm">
              ...
              <li className="flex items-center gap-2 text-white/60"><MapPin size={14} className="text-primary" />  Rosário - Santa Fe</li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-12 pt-6 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-white/40">
          <p>© 2024 Infinity Smart Digital. Todos los derechos reservados.</p>
          <p className="font-mono text-[10px] text-white/25">CUIT 30-71881009-0</p>
        </div>
      </div>
    </footer>
  );
